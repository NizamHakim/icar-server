import { ScheduleSession } from "../../generated/prisma/enums";
import { prisma } from "../../src/utils/prisma";
import { DateTime } from "luxon";
import { BadGatewayError } from "../../src/utils/errors/expectedError/BadGatewayError";
  ...
  while (current < end) {
    await prisma.schedule.create({
      data: {
        ...
        arrivalTime: timeUtils.dateToTime(current.toJSDate()),
        session: session,
      },
    });
